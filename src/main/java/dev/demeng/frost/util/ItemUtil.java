...
public final class ItemUtil {
  ...
  public static ItemStack createUnbreakableItem(Material material, String name, int amount,
      short damage) {
    ItemStack item = new ItemStack(material, amount, damage);
    ItemMeta meta = item.getItemMeta();
  ...
  public static ItemStack createNoFlagsItem(Material material, String name, int amount,
      short damage) {
    ItemStack item = new ItemStack(material, amount, damage);
    ItemMeta meta = item.getItemMeta();
    ...
    meta.spigot().setUnbreakable(true);
    meta.addItemFlags(ItemFlag.HIDE_ENCHANTS, ItemFlag.HIDE_UNBREAKABLE,
        ItemFlag.HIDE_POTION_EFFECTS, ItemFlag.HIDE_UNBREAKABLE, ItemFlag.HIDE_ATTRIBUTES);
    item.setItemMeta(meta);

    return item;
  }

  public static ItemStack createPlayerHead(Material material, String name, String playerHead,
  ...
  public static ItemStack updateAmount(ItemStack item, int amount) {
    if (amount == 0) {
      amount = 1;
    }
  ...
  public static ItemStack updateLoreAndAmount(ItemStack item, int amount, String... lore) {
    if (amount == 0) {
      amount = 1;
    }
    item.setAmount(amount);

    return reloreItem(ReloreType.OVERWRITE, item, lore);
  }
