package dev.demeng.frost.util.time;
...
public class Cooldown {
  ...
  public boolean equals(Object o) {
    ...
    if (this$uniqueId == null) {
      if (other$uniqueId == null) {
        return (getStart() == other.getStart() && getExpire() == other.getExpire()
  ...
  public String toString() {
    return "Cooldown(uniqueId=" + getUniqueId() + ", start=" + getStart() + ", expire="
        + getExpire() + ", notified=" + isNotified() + ")";
  }
